...
/* ═══════════════════════════════════════════
   TESTIMONIOS DE PROFESIONALES POR CARRERA
   ═══════════════════════════════════════════ */
const testimoniosDB = {
  "Neurociencia": [
    { nombre:"Valentina Restrepo", edad:28, pais:"🇨🇴→🇩🇪", rol:"Neurocientífica, Instituto Max Planck, Berlín", avatar:"V", historia:"En el colegio todos pensaban que yo era rara porque me obsesionaba entender por qué la gente actúa como actúa. Estudié psicología en la Javeriana, hice una maestría en neurociencia cognitiva con una beca del DAAD alemán, y hoy investigo cómo el cerebro procesa la música. Lo que nadie te dice es que la neurociencia es 50% ciencia y 50% filosofía — todos los días haces preguntas que nadie ha respondido.", consejo:"No te asustes si tus notas en matemáticas no son las mejores. Yo era mala en cálculo y aquí estoy. Lo que importa es tu curiosidad y tu capacidad de hacer preguntas nuevas." },
    { nombre:"Rafael Okonkwo", edad:34, pais:"🇧🇷→🇺🇸", rol:"Investigador en BCI (Brain-Computer Interface), Boston", avatar:"R", historia:"Nací en São Paulo y crecí viendo documentales sobre el cerebro. Mi papá me decía que estudiara medicina, pero yo quería algo más específico. Estudié ingeniería biomédica con enfoque en neurociencia y hoy trabajo en interfaces cerebro-computadora para ayudar a personas con parálisis. Cada vez que veo a un paciente mover una prótesis con el pensamiento, lloro.", consejo:"La neurociencia no es una sola carrera, son muchas. Puedes entrar desde medicina, psicología, ingeniería, biología, física. Elige el camino que más te emocione." },
  ],
  "Psicología": [
    { nombre:"Camila Mendoza", edad:31, pais:"🇲🇽→🇪🇸", rol:"Psicóloga Clínica, consulta privada en Barcelona", avatar:"C", historia:"Estudié psicología porque de adolescente fui voluntaria en una línea de ayuda para jóvenes y me di cuenta de cuánto podían cambiar las personas cuando alguien las escuchaba sin juzgar. Hoy tengo mi propia consulta y combino terapia presencial con sesiones online para pacientes de toda América Latina. Es la profesión más gratificante que conozco, pero también la más demandante emocionalmente.", consejo:"Si piensas en psicología, haz voluntariado antes de decidirte. Necesitas saber si puedes sostener el peso emocional de escuchar historias difíciles todos los días." },
    { nombre:"Juan Pablo Zeballos", edad:29, pais:"🇵🇪→🇨🇱", rol:"Psicólogo Organizacional en empresa tech, Santiago", avatar:"J", historia:"Todos piensan que un psicólogo solo hace terapia, pero yo trabajo en una empresa de tecnología diseñando cómo las personas se relacionan con sus equipos, cómo tomar mejores decisiones y cómo prevenir el burnout. Gano muy bien y puedo aplicar todo lo que aprendí en la universidad de una forma práctica y medible.", consejo:"La psicología organizacional es una de las áreas menos conocidas pero mejor pagadas. Si te gusta el mundo empresarial pero también las personas, es perfecta." },
  ],
  "Medicina": [
    { nombre:"Dra. Sofía Araújo", edad:35, pais:"🇵🇦", rol:"Médica Internista, Hospital Santo Tomás, Panamá", avatar:"S", historia:"Soñaba con ser médica desde los 7 años cuando mi abuela se enfermó y no entendíamos lo que le pasaba. Estudié medicina en la Universidad de Panamá (beca IFARHU completa), hice mi residencia en medicina interna y hoy atiendo pacientes todos los días. La carrera es larguísima, cuesta mucho, pero cuando un paciente te dice gracias por salvarle la vida a su madre, todo vale la pena.", consejo:"Medicina no es para quien quiere ganar dinero rápido. Es una vocación. Pregúntate si estás dispuesta a sacrificar 10 años de tu vida estudiando y trabajando 80 horas semanales." },
    { nombre:"Dr. Mateo Ferreira", edad:42, pais:"🇺🇾→🇺🇸", rol:"Cirujano cardiovascular, Mayo Clinic, Minnesota", avatar:"M", historia:"Vengo de un pueblo pequeño de Uruguay donde nadie en mi familia había ido a la universidad. Hoy opero corazones en una de las mejores clínicas del mundo. El camino fue brutal — estudiar en Uruguay, revalidar título en EE.UU., aprobar los exámenes USMLE, hacer residencia... pero todo fue posible gracias a que nunca dejé de creer. Mi consejo: el origen no te define.", consejo:"Si vienes de un lugar pequeño o de una familia sin profesionales, eso no importa. Lo que importa es tu disciplina y tu capacidad de no rendirte cuando el camino se ponga imposible." },
  ],
  "Ingeniería de Software": [
    { nombre:"Andrés Fuentes", edad:26, pais:"🇵🇦→🇺🇸", rol:"Senior Software Engineer en Silicon Valley", avatar:"A", historia:"En el colegio yo era el chico de los videojuegos — mi mamá pensaba que estaba perdiendo el tiempo. Un profesor me mostró que detrás de cada juego hay miles de líneas de código y me enamoré de la programación. Estudié en la UTP con beca, hice pasantías remotas durante la universidad, y a los 24 años conseguí trabajo en una empresa de Silicon Valley. Hoy trabajo desde Panamá ganando en dólares.", consejo:"No necesitas estudiar en EE.UU. para conseguir un trabajo allá. Aprende inglés, haz proyectos personales en GitHub, y participa en retos de código como LeetCode. Los mejores trabajos tech son remotos." },
    { nombre:"Isabella Navarro", edad:30, pais:"🇻🇪→🇳🇱", rol:"Tech Lead en fintech europea, Ámsterdam", avatar:"I", historia:"Empecé a programar a los 16 años viendo tutoriales gratuitos en YouTube. Estudié ingeniería de sistemas en Venezuela, me fui a Colombia como refugiada, y desde allá conseguí trabajo remoto para una empresa holandesa. Dos años después me contrataron oficialmente y me mudé a Ámsterdam. Soy la única mujer en mi equipo pero eso está cambiando rápido.", consejo:"A las chicas: no se intimiden con los espacios masculinos. La programación necesita más perspectivas femeninas. Y empiecen con un lenguaje fácil como Python — lo difícil viene después." },
  ],
  "Diseño Gráfico": [
    { nombre:"Lucas Beltrán", edad:27, pais:"🇨🇱→🇨🇦", rol:"Director de Arte en agencia, Toronto", avatar:"L", historia:"Mi papá me decía que del arte no se vive. Hoy gano más que él como director de arte en una de las agencias más premiadas de Canadá. Estudié diseño gráfico en Chile, abrí una cuenta de Behance con mis proyectos universitarios, y un reclutador canadiense me encontró ahí. La clave fue construir un portfolio desde el primer día de la carrera, no esperar a graduarme.", consejo:"El portfolio lo es todo. Más que tu título, más que tus notas. Desde el primer semestre empieza a subir tus mejores trabajos a Behance, Dribbble o Instagram. Es tu tarjeta de presentación al mundo." },
    { nombre:"Daniela Rojas", edad:29, pais:"🇨🇷→💻", rol:"Diseñadora freelance, nómada digital", avatar:"D", historia:"Después de graduarme, decidí no buscar trabajo de oficina. Me convertí en freelance y ahora trabajo desde donde quiera — este año he estado en Bali, México y Portugal. Tengo clientes en 8 países y gano más de lo que ganaría en una agencia tradicional en Costa Rica. La creatividad no tiene oficina.", consejo:"Si eres creativo/a y te gusta la libertad, considera el freelance. Necesitas disciplina propia, pero la libertad que da es incomparable. Empieza haciendo proyectos para pequeños negocios locales." },
  ],
  "Marketing Digital": [
    { nombre:"Gabriela Torres", edad:26, pais:"🇵🇦", rol:"Growth Marketing Manager, startup fintech", avatar:"G", historia:"Estudié marketing porque me encantaba entender por qué la gente compra lo que compra. Durante la carrera empecé a manejar las redes de un negocio familiar y descubrí el marketing digital. Hoy dirijo el crecimiento de una startup fintech que tiene 200,000 usuarios. Lo que más me apasiona es ver cómo una buena campaña puede cambiar el destino de una empresa.", consejo:"No esperes a graduarte para practicar. Ofrécete a manejar las redes de un familiar, de un pequeño negocio, o de una causa social. Los resultados reales son mil veces más valiosos que las notas." },
    { nombre:"Santiago Molina", edad:32, pais:"🇨🇴", rol:"Fundador de agencia digital, Medellín", avatar:"S", historia:"Estudié marketing y publicidad, trabajé 5 años en agencias grandes, y después monté la mía propia con dos amigos. Hoy tenemos 15 empleados y clientes en toda Latinoamérica. El marketing digital es la carrera más democrática que existe — puedes ser bueno sin tener un posgrado caro, solo con resultados y creatividad.", consejo:"Aprende a usar herramientas como Google Analytics, Meta Ads y SEO desde el primer año. Certifícate en ellas gratis online. Son lo que los empleadores realmente valoran." },
  ],
  "Arquitectura": [
    { nombre:"Paula Hernández", edad:33, pais:"🇲🇽→🇯🇵", rol:"Arquitecta en firma internacional, Tokio", avatar:"P", historia:"Desde niña dibujaba casas en servilletas. Estudié arquitectura en la UNAM, hice un intercambio en Japón y me enamoré de la arquitectura japonesa. Hoy trabajo en una firma que diseña edificios en Asia. La carrera es larga (5 años) y demandante, pero cada vez que veo un edificio que diseñé en la vida real, me emociono como la primera vez.", consejo:"La arquitectura combina arte, matemáticas, ingeniería y psicología. Si te gusta solo una de esas cosas, quizás hay mejores carreras. Pero si te gustan todas, esta es para ti." },
  ],
  "Administración": [
    { nombre:"Ricardo Vargas", edad:38, pais:"🇦🇷→🇺🇸", rol:"CEO de startup tech, Miami", avatar:"R", historia:"Estudié administración de empresas en Buenos Aires. Trabajé en corporativos grandes por 8 años hasta que un día me cansé y decidí crear mi propia empresa. Hoy tengo una startup de 40 empleados valorada en millones. La administración no es solo hacer Excel — es aprender a liderar personas y tomar decisiones bajo presión.", consejo:"Si sueñas con emprender, empieza a emprender desde ya. Vende cualquier cosa, organiza cualquier evento, lidera cualquier equipo. La experiencia real enseña más que cualquier clase." },
  ],
  "Ing. Ambiental": [
    { nombre:"Alejandro Duarte", edad:31, pais:"🇨🇷→🇳🇴", rol:"Ingeniero de proyectos solares, Oslo", avatar:"A", historia:"Crecí en una finca de café en Costa Rica viendo cómo el cambio climático afectaba las cosechas de mi familia. Decidí estudiar ingeniería ambiental para ser parte de la solución. Hoy diseño sistemas de energía solar para comunidades rurales en Escandinavia. Nunca imaginé que un chico de una finca podría trabajar en Noruega.", consejo:"Las carreras verdes son el futuro. La demanda está creciendo exponencialmente y hay muchas becas disponibles para estudiar sostenibilidad en Europa. No dejes pasar esa oportunidad." },
  ],
  "Piloto Comercial": [
    { nombre:"Capitán Luis Morales", edad:40, pais:"🇵🇦", rol:"Piloto Capitán, aerolínea internacional", avatar:"L", historia:"Desde los 5 años soñaba con volar. Mi familia no podía pagar la escuela de aviación, pero conseguí una beca y trabajé como mesero mientras estudiaba. Hoy vuelo Boeing 787 en rutas intercontinentales. Gano más de $180,000 al año y trabajo 15 días al mes. Los otros 15 estoy con mi familia o viajando por placer.", consejo:"La aviación es costosa pero hay becas. Investiga en las academias de Panamá, Colombia o México. Si tu sueño es volar, no dejes que el dinero te detenga." },
  ],
  "Marina Mercante": [
    { nombre:"Carlos Ramírez", edad:28, pais:"🇵🇦→🌊", rol:"Oficial de cubierta, buque portacontenedores", avatar:"C", historia:"En mi colegio nadie hablaba de la marina mercante. Fue mi tío, que es marino, quien me contó de esta carrera. Estudié en la Escuela Náutica de Panamá y hoy soy oficial de navegación en un buque que cruza el Canal de Panamá, el Canal de Suez y los puertos más grandes del mundo. Gano más que muchos amigos con maestría y he conocido 30 países.", consejo:"Si te gusta la aventura y no te marean las alturas ni el mar, la marina mercante es una joya escondida. Panamá tiene la Escuela Náutica y el registro marítimo más grande del mundo — somos privilegiados." },
  ],
};
...
const universities = [
  {id:1,nombre:"MIT — Massachusetts Institute of Technology",pais:"🇺🇸 EE.UU.",ciudad:"Cambridge, Massachusetts",region:"americas",ranking:"#1 Mundial en Tecnología e Ingeniería",mundos:["tech","mente","salud"],costo:"$57,000 USD/año",tasaAceptacion:"3.9%",idioma:"Inglés",modalidad:"Presencial",web:"mit.edu",color:"#1E3A5F",
    desc:"La universidad tecnológica más prestigiosa del mundo. Ha producido 98 premios Nobel y es cuna de empresas como Dropbox, Intel y Buzzfeed. Su programa OpenCourseWare ha democratizado la educación global.",
    carrerasDestacadas:["Ingeniería de Software","IA","Neurociencia","Robótica","Biotecnología"],
    becasDetalle:[{nombre:"MIT Financial Aid",cobertura:"100% basada en necesidad",detalle:"Cubre matrícula completa para familias con ingresos menores a $75,000/año. Más del 58% de los estudiantes reciben ayuda."},{nombre:"Fulbright Program",cobertura:"Completa",detalle:"Para estudiantes internacionales con excelencia académica. Cubre matrícula, manutención y vuelos."}],
    dato:"El 58% de los estudiantes de pregrado reciben ayuda financiera significativa."},
  {id:2,nombre:"Universidad de los Andes",pais:"🇨🇴 Colombia",ciudad:"Bogotá",region:"americas",ranking:"#1 en Colombia · Top 5 Latinoamérica",mundos:["negocios","social","tech"],costo:"$8,000-12,000 USD/año",tasaAceptacion:"15%",idioma:"Español (programas bilingües)",modalidad:"Presencial y Híbrido",web:"uniandes.edu.co",color:"#D97706",
    desc:"La universidad privada líder de Colombia y una de las mejores de Latinoamérica. Reconocida por su excelencia académica y su campus en el corazón de Bogotá. Tiene convenios con más de 200 universidades en el mundo para intercambios estudiantiles.",
    carrerasDestacadas:["Administración","Derecho","Ingeniería de Software","Economía","Medicina"],
    becasDetalle:[{nombre:"Quiero Estudiar",cobertura:"Hasta 95% del costo",detalle:"Programa emblemático de becas para estudiantes de bajos recursos con alto rendimiento académico."},{nombre:"Beca de Excelencia",cobertura:"50-100%",detalle:"Para los mejores puntajes en exámenes de admisión, sin importar situación económica."}],
    dato:"Tiene convenios con más de 200 universidades en el mundo para intercambios."},
  {id:3,nombre:"Universidad de Panamá",pais:"🇵🇦 Panamá",ciudad:"Ciudad de Panamá",region:"americas",ranking:"Principal universidad pública de Panamá",mundos:["social","salud","negocios"],costo:"$500-1,500 USD/año",tasaAceptacion:"60%",idioma:"Español",modalidad:"Presencial",web:"up.ac.pa",color:"#2563EB",
    desc:"La universidad más grande y antigua de Panamá, fundada en 1935. Accesible económicamente y con fuerte impacto social. Forma a la mayoría de profesionales del sector público del país y gradúa más del 40% de los profesionales de Panamá.",
    carrerasDestacadas:["Derecho","Medicina","Administración","Educación","Trabajo Social"],
    becasDetalle:[{nombre:"Beca IFARHU",cobertura:"Variable según necesidad",detalle:"Programa nacional de becas del gobierno panameño. Aplica para estudiantes de todos los niveles socioeconómicos."},{nombre:"Beca de Honor",cobertura:"Matrícula completa",detalle:"Para estudiantes con índice académico superior a 2.0 sobre 3.0."}],
    dato:"Gradúa más del 40% de los profesionales que trabajan en Panamá."},
  {id:4,nombre:"Universidad Tecnológica de Panamá (UTP)",pais:"🇵🇦 Panamá",ciudad:"Ciudad de Panamá",region:"americas",ranking:"Líder en ingeniería y tecnología en Panamá",mundos:["tech","naturaleza","accion"],costo:"$800-2,000 USD/año",tasaAceptacion:"45%",idioma:"Español",modalidad:"Presencial y Semi-presencial",web:"utp.ac.pa",color:"#1E3A5F",
    desc:"La principal universidad tecnológica de Panamá. Especializada en ingenierías y ciencias exactas, con fuerte conexión con la industria y el sector logístico del país. Sus ingenieros son los más demandados en el Canal de Panamá y la zona logística.",
    carrerasDestacadas:["Ingeniería de Software","Ing. Ambiental","Energías Renovables","Ingeniería Civil","Ciencia de Datos"],
    becasDetalle:[{nombre:"Beca IFARHU-SENACYT",cobertura:"Completa",detalle:"Para carreras STEM con excelencia académica. Incluye matrícula, libros y estipendio mensual."},{nombre:"Beca UTP Excelencia",cobertura:"50-100%",detalle:"Basada en rendimiento académico continuado durante la carrera."}],
    dato:"Sus ingenieros son los más demandados en el Canal de Panamá y la zona logística."},
  {id:5,nombre:"UNAM — Universidad Nacional Autónoma de México",pais:"🇲🇽 México",ciudad:"Ciudad de México",region:"americas",ranking:"#1 en México · Top 3 Latinoamérica",mundos:["mente","salud","social","creativo"],costo:"$100-500 USD/año",tasaAceptacion:"8%",idioma:"Español",modalidad:"Presencial y a distancia",web:"unam.mx",color:"#1E3A5F",
    desc:"La universidad más grande e importante de habla hispana. Su campus central es Patrimonio de la Humanidad por la UNESCO. Pública y con altísima calidad. Ha producido 3 premios Nobel y es la universidad con más publicaciones científicas de Latinoamérica.",
    carrerasDestacadas:["Medicina","Psicología","Neurociencia","Arquitectura","Derecho","Cine"],
    becasDetalle:[{nombre:"Beca UNAM",cobertura:"Matrícula + manutención",detalle:"Múltiples programas para estudiantes nacionales e internacionales de todos los niveles."},{nombre:"Beca Santander",cobertura:"Parcial",detalle:"Convenio internacional para movilidad estudiantil en más de 20 países."}],
    dato:"Ha producido 3 premios Nobel y es la universidad con más publicaciones científicas de Latinoamérica."},
  {id:6,nombre:"Stanford University",pais:"🇺🇸 EE.UU.",ciudad:"Stanford, California",region:"americas",ranking:"#2-3 Mundial · Cuna de Silicon Valley",mundos:["tech","negocios","creativo"],costo:"$60,000 USD/año",tasaAceptacion:"3.6%",idioma:"Inglés",modalidad:"Presencial",web:"stanford.edu",color:"#8C1515",
    desc:"La universidad que creó Silicon Valley. De aquí nacieron Google, Netflix, LinkedIn y miles de startups. Combina excelencia académica con cultura emprendedora única. Si Stanford fuera un país, su red de alumni tendría la 10ª economía más grande del mundo.",
    carrerasDestacadas:["IA","Emprendimiento","Diseño UX/UI","Ciencia de Datos","Ingeniería de Software"],
    becasDetalle:[{nombre:"Stanford Financial Aid",cobertura:"100% basada en necesidad",detalle:"Familias con ingresos menores a $100,000 no pagan matrícula. Una de las ayudas más generosas del mundo."},{nombre:"Knight-Hennessy Scholars",cobertura:"Completa",detalle:"La beca de posgrado más grande del mundo. Cubre todo: matrícula, vida, viajes y proyectos."}],
    dato:"Si Stanford fuera un país, su red de alumni tendría la 10ª economía más grande del mundo."},
  {id:7,nombre:"Universidad de São Paulo (USP)",pais:"🇧🇷 Brasil",ciudad:"São Paulo",region:"americas",ranking:"#1 en Brasil y Latinoamérica",mundos:["salud","tech","naturaleza"],costo:"Gratuita (pública)",tasaAceptacion:"5%",idioma:"Portugués (algunos programas en inglés)",modalidad:"Presencial",web:"usp.br",color:"#2563EB",
    desc:"La mejor universidad de Latinoamérica según la mayoría de rankings internacionales. Líder en investigación científica con más de 90,000 estudiantes. Produce el 25% de toda la investigación científica de Brasil.",
    carrerasDestacadas:["Medicina","Biotecnología","Ingeniería","Biología Marina","Ciencia de Datos"],
    becasDetalle:[{nombre:"FAPESP",cobertura:"Completa + investigación",detalle:"Becas de investigación para pregrado y posgrado con financiación de proyectos."},{nombre:"PEC-G",cobertura:"Completa",detalle:"Programa del gobierno brasileño para estudiantes de países en desarrollo."}],
    dato:"Produce el 25% de toda la investigación científica de Brasil."},
  {id:8,nombre:"Universidad de Oxford",pais:"🇬🇧 Reino Unido",ciudad:"Oxford, Inglaterra",region:"europa",ranking:"#1 Mundial (Times Higher Education)",mundos:["mente","social","salud"],costo:"£28,000-40,000 GBP/año",tasaAceptacion:"15%",idioma:"Inglés",modalidad:"Presencial con sistema tutorial",web:"ox.ac.uk",color:"#1E3A5F",
    desc:"La universidad más antigua del mundo angloparlante (fundada en 1096). Legendaria en humanidades, ciencias y formación de líderes mundiales — 28 primeros ministros británicos estudiaron aquí. Su sistema de tutorías 1-a-1 es único en el mundo.",
    carrerasDestacadas:["Neurociencia","Derecho","Filosofía","Medicina","Relaciones Internacionales"],
    becasDetalle:[{nombre:"Clarendon Scholarship",cobertura:"Completa",detalle:"Cubre matrícula y manutención para estudiantes internacionales excepcionales."},{nombre:"Rhodes Scholarship",cobertura:"Completa",detalle:"La beca internacional más antigua y prestigiosa del mundo. Para líderes con impacto global."}],
    dato:"28 primeros ministros británicos estudiaron en Oxford."},
  {id:9,nombre:"TU Munich — Technische Universität München",pais:"🇩🇪 Alemania",ciudad:"Múnich, Baviera",region:"europa",ranking:"#1 en Alemania · Top 30 Mundial",mundos:["tech","naturaleza","salud"],costo:"€250/semestre (casi gratuita)",tasaAceptacion:"8%",idioma:"Alemán e Inglés",modalidad:"Presencial",web:"tum.de",color:"#2563EB",
    desc:"La mejor universidad técnica de Alemania y una de las mejores de Europa. Gratuita incluso para estudiantes internacionales. Tiene fuerte conexión con la industria automotriz y tecnológica alemana — BMW, Siemens y muchas empresas tech reclutan directamente aquí.",
    carrerasDestacadas:["Robótica","Ing. Ambiental","Biotecnología","IA","Energías Renovables"],
    becasDetalle:[{nombre:"DAAD Scholarship",cobertura:"Completa + manutención",detalle:"El servicio alemán de intercambio ofrece miles de becas para estudiantes latinoamericanos cada año."},{nombre:"Deutschland Stipendium",cobertura:"€300/mes",detalle:"Beca de mérito para estudiantes destacados. Renovable cada año."}],
    dato:"BMW, Siemens y muchas empresas tech alemanas reclutan directamente aquí."},
  {id:10,nombre:"Politecnico di Milano",pais:"🇮🇹 Italia",ciudad:"Milán",region:"europa",ranking:"#1 Italia en Ingeniería y Diseño",mundos:["creativo","tech","negocios"],costo:"€900-3,900 EUR/año",tasaAceptacion:"20%",idioma:"Italiano e Inglés",modalidad:"Presencial",web:"polimi.it",color:"#1E3A5F",
    desc:"La mejor universidad de diseño e ingeniería de Italia, ubicada en la capital mundial de la moda y el diseño. Muchos programas en inglés. Milán es sede de firmas como Armani, Prada, Pirelli y Luxottica — todas reclutan aquí.",
    carrerasDestacadas:["Arquitectura","Diseño Industrial","Diseño de Moda","Ingeniería de Software","Animación 3D"],
    becasDetalle:[{nombre:"DSU Scholarship",cobertura:"Matrícula + alojamiento",detalle:"Basada en situación económica. Cubre costos de vida para internacionales."},{nombre:"Merit Award",cobertura:"€10,000/año",detalle:"Para los mejores candidatos internacionales admitidos."}],
    dato:"Milán es sede de Armani, Prada, Pirelli y Luxottica — todas reclutan aquí."},
  {id:11,nombre:"Universidad de Barcelona",pais:"🇪🇸 España",ciudad:"Barcelona",region:"europa",ranking:"#1 en España · Top 100 Mundial",mundos:["salud","creativo","social"],costo:"€1,500-3,500 EUR/año",tasaAceptacion:"25%",idioma:"Español y Catalán",modalidad:"Presencial",web:"ub.edu",color:"#D97706",
    desc:"La mejor universidad de España, ubicada en una de las ciudades más vibrantes del mundo. Excelente para latinoamericanos por el idioma y la calidad de vida. Barcelona es consistentemente la ciudad #1 en Europa para estudiantes internacionales.",
    carrerasDestacadas:["Medicina","Psicología","Arquitectura","Bellas Artes","Derecho"],
    becasDetalle:[{nombre:"Beca Santander Iberoamérica",cobertura:"Parcial + viaje",detalle:"Para estudiantes latinoamericanos de intercambio. Cubre matrícula y parte de los gastos."},{nombre:"Beca MAEC-AECID",cobertura:"Completa",detalle:"Programa de cooperación española para estudiantes de países en desarrollo."}],
    dato:"Barcelona es la ciudad #1 en Europa para estudiantes internacionales según QS."},
  {id:12,nombre:"ETH Zürich",pais:"🇨🇭 Suiza",ciudad:"Zúrich",region:"europa",ranking:"#7 Mundial · #1 Europa Continental",mundos:["tech","naturaleza","mente"],costo:"CHF 1,460/año",tasaAceptacion:"27%",idioma:"Alemán e Inglés",modalidad:"Presencial",web:"ethz.ch",color:"#1E3A5F",
    desc:"La mejor universidad de Europa continental, donde estudió Albert Einstein. Líder mundial en ciencia, tecnología e investigación ambiental. 21 premios Nobel han salido de ETH Zürich, incluyendo al propio Einstein.",
    carrerasDestacadas:["IA","Ing. Ambiental","Neurociencia","Robótica","Ciencias del Clima"],
    becasDetalle:[{nombre:"ETH Excellence Scholarship",cobertura:"Completa + estipendio",detalle:"Para los mejores estudiantes de maestría del mundo. Incluye manutención completa."},{nombre:"Swiss Government Excellence Scholarship",cobertura:"Completa",detalle:"Beca del gobierno suizo para estudiantes internacionales destacados."}],
    dato:"21 premios Nobel han salido de ETH Zürich, incluyendo Albert Einstein."},
  {id:13,nombre:"University of Tokyo (Todai)",pais:"🇯🇵 Japón",ciudad:"Tokio",region:"asia",ranking:"#1 en Japón · Top 30 Mundial",mundos:["tech","mente","salud"],costo:"¥535,800/año (~$3,600 USD)",tasaAceptacion:"35% (internacionales)",idioma:"Japonés e Inglés (programas PEAK)",modalidad:"Presencial",web:"u-tokyo.ac.jp",color:"#2563EB",
    desc:"La universidad más prestigiosa de Japón y líder en Asia. Conocida por su investigación de vanguardia en tecnología, ciencia y medicina. Japón ofrece la beca MEXT, considerada la más completa del mundo: paga absolutamente TODO incluyendo vuelos y estipendio mensual.",
    carrerasDestacadas:["Robótica","IA","Neurociencia","Biotecnología","Medicina"],
    becasDetalle:[{nombre:"MEXT Scholarship",cobertura:"Completa + vuelos + estipendio",detalle:"La beca más generosa del gobierno japonés. Cubre matrícula, vuelos, ¥117,000/mes de manutención y curso de japonés."},{nombre:"UTokyo Fellowship",cobertura:"¥200,000/mes",detalle:"Para estudiantes de posgrado internacionales destacados."}],
    dato:"La beca MEXT de Japón es considerada la más completa del mundo: paga TODO."},
  {id:14,nombre:"National University of Singapore (NUS)",pais:"🇸🇬 Singapur",ciudad:"Singapur",region:"asia",ranking:"#1 en Asia · Top 10 Mundial",mundos:["negocios","tech","salud"],costo:"$8,000-15,000 USD/año",tasaAceptacion:"12%",idioma:"Inglés",modalidad:"Presencial",web:"nus.edu.sg",color:"#1E3A5F",
    desc:"La mejor universidad de Asia, ubicada en uno de los centros financieros más importantes del mundo. Increíblemente global — estudiantes de más de 100 países. Singapur invierte más en educación per cápita que cualquier otro país del mundo.",
    carrerasDestacadas:["Finanzas","Ciencia de Datos","IA","Medicina","Comercio Internacional"],
    becasDetalle:[{nombre:"NUS Global Merit Scholarship",cobertura:"Completa + alojamiento + viajes",detalle:"Para los mejores estudiantes internacionales admitidos. Incluye oportunidades de intercambio."},{nombre:"ASEAN Undergraduate Scholarship",cobertura:"Completa",detalle:"Para estudiantes del sudeste asiático con excelencia académica."}],
    dato:"Singapur invierte más en educación per cápita que cualquier otro país del mundo."},
  {id:15,nombre:"Seoul National University",pais:"🇰🇷 Corea del Sur",ciudad:"Seúl",region:"asia",ranking:"#1 Corea del Sur · Top 30 Mundial",mundos:["tech","creativo","negocios"],costo:"$4,000-7,000 USD/año",tasaAceptacion:"20% (internacionales)",idioma:"Coreano e Inglés",modalidad:"Presencial",web:"snu.ac.kr",color:"#1E3A5F",
    desc:"La universidad más prestigiosa de Corea del Sur, el país líder en tecnología, entretenimiento (K-pop, K-dramas) y diseño. Samsung, LG y Hyundai reclutan aquí directamente. Corea del Sur es el país más conectado del mundo con 97% de penetración de internet.",
    carrerasDestacadas:["Ingeniería de Software","Diseño UX/UI","Animación 3D","Marketing Digital","IA"],
    becasDetalle:[{nombre:"Korean Government Scholarship (GKS)",cobertura:"Completa + vuelos + idioma",detalle:"Incluye un año de curso de coreano gratuito antes de la carrera. Una de las becas más completas de Asia."},{nombre:"SNU Merit Scholarship",cobertura:"50-100%",detalle:"Basada en excelencia académica continuada."}],
    dato:"Corea del Sur es el país más conectado del mundo con 97% de penetración de internet."},
  {id:16,nombre:"Tsinghua University",pais:"🇨🇳 China",ciudad:"Pekín",region:"asia",ranking:"#1 en China · Top 15 Mundial",mundos:["tech","negocios","naturaleza"],costo:"¥40,000/año (~$5,500 USD)",tasaAceptacion:"15% (internacionales)",idioma:"Chino e Inglés",modalidad:"Presencial",web:"tsinghua.edu.cn",color:"#D97706",
    desc:"La universidad más prestigiosa de China, conocida como el 'MIT de Asia'. Líder mundial en IA, ingeniería y ha graduado a la mayoría de los líderes chinos. China otorga más becas completas a latinoamericanos que cualquier otro país asiático.",
    carrerasDestacadas:["IA","Ingeniería de Software","Energías Renovables","Finanzas","Robótica"],
    becasDetalle:[{nombre:"Chinese Government Scholarship (CSC)",cobertura:"Completa + estipendio",detalle:"El gobierno chino ofrece miles de becas completas a latinoamericanos cada año. Incluye alojamiento."},{nombre:"Schwarzman Scholars",cobertura:"Completa",detalle:"Programa de liderazgo global con maestría incluida. Una de las becas más competitivas del mundo."}],
    dato:"China otorga más becas completas a latinoamericanos que cualquier otro país asiático."},
  {id:17,nombre:"Escuela Náutica de Panamá",pais:"🇵🇦 Panamá",ciudad:"Ciudad de Panamá",region:"americas",ranking:"Referente en Marina Mercante de Latinoamérica",mundos:["accion","negocios"],costo:"$1,000-3,000 USD/año",tasaAceptacion:"50%",idioma:"Español e Inglés",modalidad:"Presencial con prácticas a bordo",web:"enm.ac.pa",color:"#1E3A5F",
    desc:"Forma oficiales de marina mercante para el registro marítimo más grande del mundo. Panamá tiene una posición estratégica única con el Canal y la zona franca, lo que convierte a sus graduados en los más buscados por navieras internacionales.",
    carrerasDestacadas:["Marina Mercante","Ingeniería Naval","Logística Portuaria","Navegación"],
    becasDetalle:[{nombre:"Beca IFARHU-Marítima",cobertura:"Completa",detalle:"Para estudiantes panameños con excelencia académica interesados en carreras marítimas."}],
    dato:"Panamá tiene el registro marítimo más grande del mundo y sus oficiales trabajan en los barcos más grandes del planeta."},
  {id:18,nombre:"Embry-Riddle Aeronautical University",pais:"🇺🇸 EE.UU.",ciudad:"Daytona Beach, Florida",region:"americas",ranking:"#1 Aviación Mundial",mundos:["accion","tech"],costo:"$40,000 USD/año",tasaAceptacion:"65%",idioma:"Inglés",modalidad:"Presencial",web:"erau.edu",color:"#1E3A5F",
    desc:"La universidad de aviación más prestigiosa del planeta. Forma pilotos comerciales, ingenieros aeroespaciales, controladores de tráfico aéreo y expertos en seguridad aérea. Sus graduados vuelan para las aerolíneas más importantes del mundo.",
    carrerasDestacadas:["Piloto Comercial","Ingeniería Aeroespacial","Control Tráfico Aéreo","Ingeniería de Software"],
    becasDetalle:[{nombre:"Embry-Riddle Academic Scholarship",cobertura:"Hasta $20,000/año",detalle:"Basada en mérito académico. Renovable cada año si se mantiene el rendimiento."},{nombre:"International Student Scholarship",cobertura:"Parcial",detalle:"Para estudiantes internacionales con excelencia académica comprobada."}],
    dato:"Los graduados de Embry-Riddle vuelan para las principales aerolíneas del mundo."},
];
...
function Nav({ page, setPage }) {
  ...
  return (
    <nav style={{
      ...
      <div onClick={() => setPage("inicio")} style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer" }}>
        <img src="/logo.png" alt="Brújula" style={{ height: "40px", width: "auto" }} />
...
function Landing({ setPage }) {
  ...
  return <div>
    <section style={{ padding: "60px 28px 40px", textAlign: "center", maxWidth: "800px", margin: "0 auto" }}>
      <img src="/logo.png" alt="Brújula" style={{ height: "140px", width: "auto", marginBottom: "8px", animation: "fadeInUp 0.5s ease-out both" }} />
      <div style={{ display: "inline-flex", gap: "8px", padding: "8px 18px", background: "#EFF6FF", borderRadius: "100px", marginBottom: "18px", fontFamily: "'DM Sans',sans-serif", fontSize: "13px", fontWeight: 600, color: "#2563EB", animation: "fadeInUp 0.5s ease-out 0.05s both" }}>
        🚀 Plataforma de orientación vocacional global
      </div>
      <h1 style={{ fontFamily: "'Fraunces',serif", fontSize: "clamp(32px,5vw,52px)", fontWeight: 800, color: "#1E3A5F", lineHeight: 1.15, marginBottom: "16px", animation: "fadeInUp 0.5s ease-out 0.1s both" }}>
        Encuentra<br/><span style={{ color: "#D97706" }}>tu camino</span>
      </h1>
    ...
    <div onClick={onClose} style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ padding: "26px 28px 32px" }}>
          ...
          {testimoniosDB[carrera] && testimoniosDB[carrera].length > 0 && (
            <div style={{ marginTop: "8px" }}>
              <h4 style={{ fontFamily: "'Fraunces',serif", fontSize: "16px", fontWeight: 700, color: "#1E3A5F", marginBottom: "4px" }}>💬 Historias reales de profesionales</h4>
              <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "12px", color: "#94A3B8", marginBottom: "14px" }}>Personas que recorrieron este camino cuentan su experiencia</p>
              <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                {testimoniosDB[carrera].map((t, i) => (
                  <div key={i} style={{
                    background: "white",
                    borderRadius: "18px",
                    padding: "22px 24px",
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "14px" }}>
                      <div style={{
                        ...
                        color: "white", fontFamily: "'Fraunces',serif", fontSize: "20px", fontWeight: 700,
                        flexShrink: 0,
                      }}>{t.avatar}</div>
                      <div style={{ flex: 1 }}>
                        <h5 style={{ fontFamily: "'Fraunces',serif", fontSize: "15px", fontWeight: 700, color: "#1E3A5F", marginBottom: "2px" }}>{t.nombre}, {t.edad}</h5>
                        <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "12px", color: "#64748B", margin: 0 }}>{t.rol}</p>
                        <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "11px", color: "#94A3B8", margin: 0 }}>{t.pais}</p>
                      </div>
                    </div>
                    <p style={{
                      fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "13px",
                      color: "#334155", lineHeight: 1.7, fontStyle: "italic",
                      marginBottom: "10px",
                    }}>"{t.historia}"</p>
                    <div style={{
                      padding: "10px 14px",
                      ...
                      }}><strong>💡 Su consejo:</strong> {t.consejo}</p>
                    </div>
                  </div>
                ))}
              </div>

              {/* Invitación a compartir historia */}
              <div style={{
                marginTop: "16px",
                padding: "18px 22px",
                ...
                <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "13px", color: "white", marginBottom: "4px", fontWeight: 600 }}>
                  ✨ ¿Eres profesional en esta carrera?
                </p>
                <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "12px", color: "rgba(255,255,255,0.75)", lineHeight: 1.5, marginBottom: "12px" }}>
                  Tu historia puede inspirar a un joven a encontrar su camino. Estamos recopilando testimonios auténticos.
                </p>
                <button style={{
                  padding: "9px 20px",
                  background: "#FBBF24",
          ...
          {(!testimoniosDB[carrera] || testimoniosDB[carrera].length === 0) && (
            <div style={{
              ...
              <p style={{ fontFamily: "'Fraunces',serif", fontSize: "16px", color: "white", fontWeight: 700, marginBottom: "6px" }}>
                Buscamos historias reales para esta carrera
              </p>
              <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "13px", color: "rgba(255,255,255,0.75)", lineHeight: 1.6, marginBottom: "14px" }}>
                ¿Eres profesional en {carrera}? Comparte tu experiencia y ayuda a jóvenes a descubrir si este es su camino.
              </p>
              <button style={{
                padding: "10px 22px",
                background: "#FBBF24",
  ...
  return <div>
    <section style={{ padding: "52px 28px 32px", textAlign: "center", maxWidth: "700px", margin: "0 auto" }}>
      ...
      <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "16px", color: "#64748B", lineHeight: 1.7, maxWidth: "500px", margin: "0 auto 24px" }}>
        {universities.length} universidades con becas reales en 3 continentes. Toca cualquiera para ver detalles completos.
      </p>
      <div style={{ maxWidth: "460px", margin: "0 auto", position: "relative" }}>
        <span style={{ position: "absolute", left: "16px", top: "50%", transform: "translateY(-50%)", fontSize: "16px" }}>🔍</span>
        <input type="text" placeholder='Busca universidad, país o ciudad...' value={search} onChange={e => setSearch(e.target.value)}
          style={{ width: "100%", padding: "14px 18px 14px 44px", borderRadius: "100px", border: "2px solid #E2E8F0", background: "white", fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "14px", color: "#1E3A5F", outline: "none" }}
          onFocus={e => e.target.style.borderColor = "#2563EB"} onBlur={e => e.target.style.borderColor = "#E2E8F0"} />
      </div>
    </section>
    ...
    <section style={{ maxWidth: "1000px", margin: "0 auto", padding: "0 28px 12px" }}>
      <div style={{ marginBottom: "10px", display: "flex", gap: "8px", flexWrap: "wrap", alignItems: "center" }}>
        <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "11px", fontWeight: 600, color: "#94A3B8", marginRight: "8px" }}>REGIÓN:</span>
      ...
      <div style={{ marginBottom: "16px", display: "flex", gap: "6px", flexWrap: "wrap", alignItems: "center" }}>
        <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "11px", fontWeight: 600, color: "#94A3B8", marginRight: "8px" }}>ÁREA:</span>
      ...
      <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "13px", color: "#94A3B8", marginBottom: "4px" }}>
        {filtered.length} universidad{filtered.length !== 1 ? "es" : ""} encontrada{filtered.length !== 1 ? "s" : ""}
      </p>
    </section>
    ...
    <section style={{ maxWidth: "1000px", margin: "0 auto", padding: "0 28px 40px" }}>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(290px,1fr))", gap: "16px" }}>
        {filtered.map((u, i) => (
          <div key={u.id} onClick={() => setSelectedUni(u)} style={{
            background: "white", borderRadius: "20px", border: "2px solid #E2E8F0", overflow: "hidden",
            cursor: "pointer", transition: "all 0.3s ease", animation: `fadeInUp 0.4s ease-out ${i * 0.06}s both`,
          }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = u.color; e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.boxShadow = `0 12px 30px ${u.color}18`; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = "#E2E8F0"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; }}>
            <div style={{ height: "5px", background: u.color }} />
            <div style={{ padding: "20px" }}>
              <div style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "12px", color: "#94A3B8", marginBottom: "4px" }}>{u.pais} · {u.ciudad}</div>
              <h3 style={{ fontFamily: "'Fraunces',serif", fontSize: "16px", fontWeight: 700, color: "#1E3A5F", marginBottom: "8px", lineHeight: 1.3 }}>{u.nombre}</h3>
              ...
              <div style={{ display: "flex", gap: "5px", flexWrap: "wrap", marginBottom: "10px" }}>
                {u.mundos.slice(0, 4).map(m => { const w = worlds.find(x => x.id === m); return w ? <span key={m} style={{ padding: "3px 8px", background: `${w.color}10`, borderRadius: "100px", fontFamily: "'DM Sans',sans-serif", fontSize: "10px", fontWeight: 600, color: w.color }}>{w.emoji} {w.name}</span> : null; })}
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", paddingTop: "10px", borderTop: "1px solid #F1F5F9" }}>
                <div><div style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "10px", color: "#94A3B8" }}>💰 Costo/año</div><div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "12px", fontWeight: 700, color: "#1E3A5F" }}>{u.costo}</div></div>
                <div><div style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "10px", color: "#94A3B8" }}>🎓 Becas</div><div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "12px", fontWeight: 700, color: "#059669" }}>{u.becasDetalle.length} disponibles</div></div>
              </div>
              <div style={{ marginTop: "10px", fontSize: "11px", fontFamily: "'DM Sans',sans-serif", fontWeight: 600, color: u.color }}>Ver detalles completos →</div>
            </div>
          </div>
        ))}
      </div>
    ...
    {selectedUni && (
      <div onClick={() => setSelectedUni(null)} style={{
        position: "fixed", inset: 0, background: "rgba(30,58,95,0.8)", backdropFilter: "blur(10px)",
        zIndex: 2000, display: "flex", alignItems: "center", justifyContent: "center", padding: "16px",
        animation: "fadeIn 0.3s ease",
      }}>
        <div onClick={e => e.stopPropagation()} style={{
          background: "#F8FAFC", borderRadius: "28px", width: "100%", maxWidth: "720px",
          maxHeight: "90vh", overflow: "auto", animation: "slideUp 0.4s cubic-bezier(0.23,1,0.32,1)",
        }}>
          {/* Header */}
          <div style={{
            background: `linear-gradient(135deg, ${selectedUni.color}, ${selectedUni.color}CC)`,
            padding: "36px 32px 28px", borderRadius: "28px 28px 0 0",
            position: "relative", overflow: "hidden",
          }}>
            <div style={{ position: "absolute", top: "-20px", right: "-20px", fontSize: "100px", opacity: 0.15 }}>🏛️</div>
            <button onClick={() => setSelectedUni(null)} style={{
              position: "absolute", top: "14px", right: "16px", background: "rgba(255,255,255,0.2)",
              border: "none", borderRadius: "50%", width: "36px", height: "36px", color: "white",
              fontSize: "18px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center",
            }}>×</button>
            <div style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "13px", color: "rgba(255,255,255,0.85)", marginBottom: "8px", position: "relative" }}>
              📍 {selectedUni.pais} · {selectedUni.ciudad}
            </div>
            <h2 style={{ fontFamily: "'Fraunces',serif", fontSize: "26px", fontWeight: 800, color: "white", lineHeight: 1.3, marginBottom: "10px", position: "relative" }}>
              {selectedUni.nombre}
            </h2>
            <span style={{
              padding: "5px 14px", background: "rgba(255,255,255,0.2)", borderRadius: "100px",
              fontFamily: "'DM Sans',sans-serif", fontSize: "12px", fontWeight: 600, color: "white", position: "relative",
            }}>⭐ {selectedUni.ranking}</span>
          </div>

          <div style={{ padding: "26px 30px 32px" }}>
            {/* Description */}
            <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "15px", color: "#334155", lineHeight: 1.8, marginBottom: "22px" }}>
              {selectedUni.desc}
            </p>

            {/* Dato clave */}
            <div style={{ padding: "14px 18px", background: `${selectedUni.color}08`, borderRadius: "12px", border: `1px solid ${selectedUni.color}20`, marginBottom: "22px" }}>
              <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "13px", color: "#1E3A5F", lineHeight: 1.6, margin: 0 }}>
                <strong>💡 Dato clave:</strong> {selectedUni.dato}
              </p>
            </div>

            {/* Stats Grid */}
            <h4 style={{ fontFamily: "'Fraunces',serif", fontSize: "16px", fontWeight: 700, color: "#1E3A5F", marginBottom: "10px" }}>📊 Información clave</h4>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "10px", marginBottom: "24px" }}>
              {[
                { icon: "💰", label: "Costo anual", value: selectedUni.costo },
                { icon: "📊", label: "Tasa de aceptación", value: selectedUni.tasaAceptacion },
                { icon: "🗣️", label: "Idioma", value: selectedUni.idioma },
                { icon: "🏫", label: "Modalidad", value: selectedUni.modalidad },
              ].map((s, i) => (
                <div key={i} style={{ padding: "12px 14px", background: "white", borderRadius: "12px", border: "1px solid #E2E8F0" }}>
                  <div style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "11px", color: "#94A3B8", marginBottom: "3px" }}>{s.icon} {s.label}</div>
                  <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "13px", fontWeight: 700, color: "#1E3A5F" }}>{s.value}</div>
                </div>
              ))}
            </div>

            {/* Carreras destacadas */}
            <h4 style={{ fontFamily: "'Fraunces',serif", fontSize: "16px", fontWeight: 700, color: "#1E3A5F", marginBottom: "10px" }}>🎯 Carreras destacadas</h4>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "7px", marginBottom: "24px" }}>
              {selectedUni.carrerasDestacadas.map((c, i) => (
                <span key={i} style={{
                  padding: "8px 14px",
                  background: "white",
                  border: `1px solid ${selectedUni.color}33`,
                  borderRadius: "100px",
            ...
            {/* Mundos */}
            <h4 style={{ fontFamily: "'Fraunces',serif", fontSize: "16px", fontWeight: 700, color: "#1E3A5F", marginBottom: "10px" }}>🌍 Mundos vocacionales</h4>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "7px", marginBottom: "24px" }}>
              {selectedUni.mundos.map(m => {
                const w = worlds.find(x => x.id === m);
                return w ? (
                  <span key={m} style={{
                    padding: "7px 14px",
            ...
            {/* Becas */}
            <h4 style={{ fontFamily: "'Fraunces',serif", fontSize: "16px", fontWeight: 700, color: "#1E3A5F", marginBottom: "10px" }}>🎓 Becas disponibles</h4>
            <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "24px" }}>
              {selectedUni.becasDetalle.map((b, i) => (
                <div key={i} style={{
                  padding: "14px 18px",
                  background: "#ECFDF5",
                  borderRadius: "12px",
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "8px", marginBottom: "6px", flexWrap: "wrap" }}>
                    <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "13px", fontWeight: 700, color: "#1E3A5F" }}>
                      🎓 {b.nombre}
                    </span>
                    <span style={{
                      padding: "3px 10px", background: "#059669", color: "white",
                      borderRadius: "100px", fontFamily: "'DM Sans',sans-serif",
                      fontSize: "10px", fontWeight: 700, whiteSpace: "nowrap",
                    }}>{b.cobertura}</span>
                  </div>
                  <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "12px", color: "#334155", lineHeight: 1.5, margin: 0 }}>
                    {b.detalle}
                  </p>
                </div>
              ))}
            ...
            <div style={{
              padding: "16px 20px", background: "linear-gradient(135deg, #1E3A5F, #2D4F7A)",
              borderRadius: "14px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "14px",
            }}>
              <div>
                <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "11px", color: "rgba(255,255,255,0.65)", marginBottom: "2px" }}>🌐 Sitio web oficial</div>
                <div style={{ fontFamily: "'Fraunces',serif", fontSize: "15px", fontWeight: 700, color: "#FBBF24" }}>{selectedUni.web}</div>
              </div>
              <a href={`https://${selectedUni.web}`} target="_blank" rel="noopener noreferrer" style={{
                padding: "8px 18px",
                background: "#FBBF24",
                color: "#1E3A5F",
                borderRadius: "100px",
  ...
  return (
    <div style={{ background: "#F8FAFC", minHeight: "100vh" }}>
      ...
      <footer style={{ padding: "20px 28px", textAlign: "center", borderTop: "1px solid #E2E8F0" }}>
        <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "12px", color: "#94A3B8" }}>🧭 Brújula — Encuentra tu camino © 2026</p>
      </footer>
    </div>
  );
}
